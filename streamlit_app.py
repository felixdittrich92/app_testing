...
def __get_text_from_image_ocrmypdf(image):
  ...
  ocrmypdf.ocr(input_file=image , output_file='x.pdfa', language='eng+deu', sidecar='test.txt', image_dpi=300, rotate_pages=True, remove_background=True, progress_bar=True)
  return text
